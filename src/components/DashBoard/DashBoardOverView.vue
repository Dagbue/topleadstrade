...
<!--              <p class="content-1-text-2" v-else-if="approved === 'Pending'">£ ...</p>-->
    ...
    <div v-show="this.screen1 === 'Forex'"  class="separate">
      ...
      <form ref="myForm" class="form-part" @submit.prevent="placeTrade">
        ...
        <base-button  style="  background-color: #01A781FF;border: 1px solid #01A781FF;" :loading="loading" >Place Trade </base-button>
      </form>
    </div>
    ...
    <div v-show="this.screen1 === 'Crypto'"  class="separate">
      ...
      <form ref="myForm" class="form-part" @submit.prevent="placeTrade">
        ...
        <base-button :loading="loading" style="  background-color: #01A781FF;border: 1px solid #01A781FF;">Place Trade</base-button>
      </form>
    </div>
